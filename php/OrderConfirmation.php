    ...
    <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Gracias por su orden</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Lista de Orden:</p>
            </div>
            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                <div class="flex flex-wrap -m-2">
                            ...
                            <div class="flow-root rounded-lg border border-gray-100 py-3 shadow-sm my-4">
                                <dl class="-my-3 divide-y divide-gray-100 text-sm">
                                    <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                                        <dt class="font-medium text-gray-900">Titulo:</dt>
                                        <dd class="text-gray-700 sm:col-span-2"><?php echo $movie['name']; ?></dd>
                                    </div>

                                    <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                                        <dt class="font-medium text-gray-900">Precio</dt>
                                        <dd class="text-gray-700 sm:col-span-2"><?php echo $movie['price'];
                                        $subtotal += $movie['price']; ?>$</dd>
                                    </div>
                                </dl>
                            </div>
                        <?php endforeach; ?>
                    ...
                    <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                        <a class="text-indigo-500">Sub-total: <?php echo $subtotal; ?>$</a>
                        <p class="leading-normal my-5">
                            Total mas Envio (9%): <?php echo number_format($subtotal * 1.09, 2);
