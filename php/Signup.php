            ...
            <main
                ...
                <div class="max-w-xl lg:max-w-3xl">
                    ...
                    <form action="POST" class="mt-8 grid grid-cols-6 gap-6" name="registration">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="Email" class="block text-sm font-medium text-gray-700"> Confirme Correo </label>
                        ...
                        <div class="col-span-6">
                            <label for="Email" class="block text-sm font-medium text-gray-700"> Direccion </label>
                        ...
                        <div class="col-span-6">
                            <label for="Email" class="block text-sm font-medium text-gray-700">Pais</label>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="Password" class="block text-sm font-medium text-gray-700">Fecha de Exp.</label>
